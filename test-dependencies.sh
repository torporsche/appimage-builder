...
cmake_minimum_required(VERSION 3.16)
project(TestQt6)
find_package(Qt6 COMPONENTS Core Widgets WebEngineCore WebEngineWidgets WaylandClient QUIET)
if(Qt6_FOUND)
    message(STATUS "Qt6 found: ${Qt6_VERSION}")
    message(STATUS "Qt6 Core found: ${Qt6Core_FOUND}")
    message(STATUS "Qt6 Widgets found: ${Qt6Widgets_FOUND}")
    message(STATUS "Qt6 WebEngineCore found: ${Qt6WebEngineCore_FOUND}")
